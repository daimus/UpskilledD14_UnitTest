...
import id.daimus.springswagger.application.product.service.DeleteProductService;
...
public class DeleteProductServiceTest {
    ...
    @Test
    void deleteProduct_WhenProductIsExist_ShouldReturnVoid() throws DataNotFoundException {
